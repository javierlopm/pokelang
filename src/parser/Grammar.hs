...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TkDId     _ happy_dollar_dollar -> cont 8;
	TkId      _ happy_dollar_dollar -> cont 9;
	TkInt     happy_dollar_dollar -> cont 10;
	TkBool    happy_dollar_dollar -> cont 11;
	TkChar    happy_dollar_dollar -> cont 12;
	TkVoid    happy_dollar_dollar -> cont 13;
	TkFloat   happy_dollar_dollar -> cont 14;
	TkStruct  happy_dollar_dollar -> cont 15;
	TkUnion   happy_dollar_dollar -> cont 16;
	TkEnum    happy_dollar_dollar -> cont 17;
	TKGlobal  happy_dollar_dollar -> cont 18;
	TkColon   happy_dollar_dollar -> cont 19;
	_ -> happyError' (tk:tks)
	}
